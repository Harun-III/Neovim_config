...
-- make the cursor as block in insert mode
vim.opt.guicursor = {
  'n-v-c:block', -- normal/visual/cmd: block
  'i-ci-ve:block', -- insert/cmdline-insert/visual-execute: block (your change)
  'r-cr:hor20', -- replace/cmdline-replace: horizontal line
  'o:hor50', -- operator-pending: horizontal line
}
